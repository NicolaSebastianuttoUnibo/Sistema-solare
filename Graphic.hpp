...
struct drawing {
static  void drawArrow(sf::Vector2f start, sf::Vector2f punta,  sf::Vector2f direction, const sf::Color &c, sf::RenderWindow& window);
static  void drawPlanet(const G::PlanetState &planet, sf::Vector2f translate, const sf::Color *color, sf::RenderWindow& window,  sf::FloatRect& visibleArea, bool check);
